  ...
  return (
    <>
      ...
      <div className="group relative">
        ...
        <DropDown menus={SETTING_DROPDOWN_MENUS} left={-100} />
      </div>
      {/* 3. setting */}
      <div className="group relative">
        <button
        ...
        >
          <svg
            className="w-7 text-white animate-spin"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
        ...
        <DropDown menus={SETTING_DROPDOWN_MENUS} left={-180} />
      </div>
      {/* 4. profile(my menu) */}
      <div className="group relative">
        ...
        <Avatar
          ...
          // badge="active"
        />
        <DropDown menus={MY_DROPDOWN_MENUS} left={-200} top="top-10" />
      </div>
    </>
  );
};
